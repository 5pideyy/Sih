...
import { logRequestData } from './service/controllers/logging'
import { startLoggingSystemHealth } from './service/controllers/moniter'
import { countRequests, getTotalRequests } from './service/controllers/requestCounter';
import { main } from './service/controllers/network-traffic'; //import network-traffic.ts

// Start the application
main();

app.use(logRequestData);  // Logs each request   // Logs errors
